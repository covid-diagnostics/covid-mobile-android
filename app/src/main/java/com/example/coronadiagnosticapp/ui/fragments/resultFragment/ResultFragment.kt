...
//      Continue text gradient:
        ...
        val SEVERELY_LOW_TEXT =
            colorizeText(resources.getString(R.string.severely_low), RED_COLOR_CODE)
        val SEVERELY_HIGH_TEXT =
            colorizeText(resources.getString(R.string.severely_high), RED_COLOR_CODE)
